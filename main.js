...
function trace(ray, depth, currentObj) {
    ...
    let reflection = trace(reflect(result.point, ray, result.normal, result.obj.properties.roughness), depth - 1, result.obj)
...
function reflect(point, ray, normal, roughness) {
